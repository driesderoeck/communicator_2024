...
static uint8_t keycodes[N_COLS][N_ROWS] = {
    { KEY_ESC, KEY_1, KEY_0, KEY_Y, },
    { KEY_F1, KEY_2, KEY_MINUS, KEY_U, },
    { KEY_F2, KEY_3, KEY_EQUAL, KEY_I, },
    { KEY_F3, KEY_4, KEY_TAB, KEY_O, },
...
static void KB_Set_Row(uint8_t rowIdx)
{
    if (rowIdx == 0) {
...
void KB_Scan_Init( void )
{
    ...
    /* Initialize GPIOA (row0-row3) as input */
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_7 | GPIO_Pin_3 | GPIO_Pin_5 | GPIO_Pin_6 ;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPD;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init( GPIOA, &GPIO_InitStructure );


    /* Initialize GPIOA (col2, col3) as output */
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1 | GPIO_Pin_0 ;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init( GPIOA, &GPIO_InitStructure );

    /* Initialize GPIOB (col0, col1) as output */
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1 | GPIO_Pin_0 ;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_Init( GPIOB, &GPIO_InitStructure );
